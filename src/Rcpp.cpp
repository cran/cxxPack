...
//
// $Id: Rcpp.cpp,v 1.3 2005/10/14 05:23:32 dsamperi Exp dsamperi $
//
...
RcppVector<T>::RcppVector(SEXP vec) {
	...
	error("RcppVector: invalid numeric vector in constructor");
...
RcppMatrix<T>::RcppMatrix(SEXP mat) {
	...
	error("RcppMatrix: invalid numeric matrix in constructor");
